...
- `tool_running`
- `waiting_for_user`
- `waiting_for_terminal` (parked on `terminal.wait` until the daemon reports the terminal settled / the command finished; superseded by a follow-up message like `waiting_for_user`)
- `streaming_message`

  ...
  const rows = [
    {
      ...
      lastConversationAt: new Date("2026-04-21T20:20:00.000Z"),
    ...
    },
    {
      ...
      lastConversationAt: new Date("2026-04-21T19:30:00.000Z"),
  ...
  assert.deepEqual(response.payload, [
    {
      ...
      last_conversation_at: new Date("2026-04-21T20:20:00.000Z"),
    ...
    },
    {
      ...
      last_conversation_at: new Date("2026-04-21T19:30:00.000Z"),
...
test("PATCH /api/threads/:threadId/model-preference persists resolved thread model selection", async (t) => {
  ...
  const thread = {
    ...
    lastConversationAt: new Date("2026-04-21T20:00:00.000Z"),
  ...
  assert.deepEqual(response.payload, {
    ...
    last_conversation_at: new Date("2026-04-21T20:00:00.000Z"),

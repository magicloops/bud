...
- first-pass gateway traffic supports `GET` and `HEAD`; request bodies,
  mutation methods, local app cookies, redirects, and WebSocket/HMR upgrades are
  follow-up phases

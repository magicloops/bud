...
| [plan/refactor-service/phase-9-web-regression-validation-before-structural-fixes.md](./plan/refactor-service/phase-9-web-regression-validation-before-structural-fixes.md) | Post-closeout validation phase for the service refactor, covering targeted instrumentation for the thread-navigation / terminal-offline web regression before any new structural fix work |
...
| [debug/web-thread-terminal-multi-tab-regression.md](./debug/web-thread-terminal-multi-tab-regression.md) | Debug note re-analyzing the post-closeout web regression after discovering a multi-tab trigger, focusing on shared thread-terminal replay/recovery semantics and why a second tab can poison the first |
| [debug/web-same-browser-multi-tab-thread-regression.md](./debug/web-same-browser-multi-tab-thread-regression.md) | Debug note re-analyzing the regression after discovering it only reproduces within the same browser profile across multiple tabs, focusing on frontend same-origin fetch/SSE behavior, unchanged localStorage usage, and why the Vite-proxied dev topology is a stronger explanation than the context refactor |

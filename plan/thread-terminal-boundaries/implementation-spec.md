...
**Rich Bootstrap Follow-Up Design**: [../../design/terminal-rich-bootstrap-contract.md](../../design/terminal-rich-bootstrap-contract.md)
...
- shipping a pixel-perfect style-preserving bootstrap renderer in the first pass
...
| Rich bootstrap capture still fails to represent the current visible screen accurately for wrapped rows or alternate-screen TUIs | Medium | High | Make the richer contract explicit about fidelity levels, validate tmux capture flags carefully, and fall back honestly rather than pretending history text is faithful |
